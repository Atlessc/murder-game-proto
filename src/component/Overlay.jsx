    ...
    return (
        <div className="Overlay">
            ...
            <div className="ActionMenu">
                <div className={`ActionItems ${toggleNPColor}`} onClick={ToggleNotepad}>
                    {
                        showNotepad ?
                        <div>Close Note</div> : <div>Notepad</div>
                    }
                </div>
                <div className={`ActionItems ${toggleRColor}`} onClick={ToggleRooms}>
                    {
                        showRooms ?
                        <div>Close Room</div>:<div>Rooms</div>
                    }
                </div>
                <div className="ActionItems Open">
                    Interview
                </div>
                <div className="ActionItems Open">
                    Accuse
