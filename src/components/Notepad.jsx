  ...
  return (
    <div className="NotepadContainer">
      ...
      <div className="NotepadTabs">
        <div className="NotepadTab" onClick={() => setTab("Notes")}>
          Notes
        </div>
        <div className="NotepadTab" onClick={() => setTab("Suspects")}>
          Suspects
        </div>
        <div className="NotepadTab" onClick={() => setTab("Rooms")}>
          Rooms
        </div>
        <div className="NotepadTab" onClick={() => setTab("Weapons")}>
          Weapons
        </div>
      </div>
      <div className="NotepadContent">
        {tab === "Notes" ? (
          ...
          <div className="NPList">
            ...
            />
            {suspectInput !== "" && (
              <button className="Submit" onClick={handleAddSuspect}>
                Submit
              </button>
            )}
            <ul className="listed">
              {noteSuspects.map((suspect, index) => (
                <li className="listItem" key={index} maxLength="10">
                  ...
                  <button
                    className="Del"
                    onClick={() => handleDeleteSuspect(index)}
                  >
                    Delete
                  </button>
                </li>
          ...
          <div className="NPList">
            ...
            />
            {roomInput !== "" && (
              <button className="Submit" onClick={handleAddRoom}>
                Submit
              </button>
            )}
            <ul>
          ...
          <div className="NPList">
            ...
            />
            {weaponInput && (
              <button className="Submit" onClick={handleAddWeapon}>
                Submit
              </button>
            )}
            <ul>
